...
class Config(object):
    # Pyrogram Client
    API_ID    = int(os.environ.get("API_ID", "35338387"))  # ⚠️ Required
    API_HASH  = os.environ.get("API_HASH", "e5cd8e78f51fa464ccfa220372e9a5c9") # ⚠️ Required
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8888073756:AAGPYUn-4LjdmU9fR0oyQ1AJ034ay7RYFZ4") # ⚠️ Required
    
    # Other Configs
    BOT_START_TIME = time.time()
    OWNER = int(os.environ.get("OWNER", "8462504573")) # ⚠️ Required
...
☛ For e.g :- <code> @USERNAME </code> or <code> https:/t.me/USERNAME </code>
"""
...
- 𝖢𝗋𝖾𝖺𝗍𝗈𝗋 : <a href=https://t.me/voxcry>J€¥</a>
- 𝖫𝗂𝖻𝗋𝖺𝗋𝗒 : Pyrogram
- 𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾 : 𝖯𝗒𝗍𝗁𝗈𝗇 𝟥
- 𝖣𝖺𝗍𝖺𝖡𝖺𝗌𝖾 : 𝖬𝗈𝗇𝗀𝗈𝖣𝖡
- 𝖡𝖮𝖳 𝖲𝖾𝗋𝗏𝖾𝗋 : 𝖠𝗇𝗒𝖶𝗁𝖾𝗋𝖾
